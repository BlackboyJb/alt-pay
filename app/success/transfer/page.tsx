        ...
        <div className="flex justify-center bg-gray-100 min-h-screen md:items-center px-4">
            <div className="flex flex-col bg-white rounded-xl w-full max-w-md text-center pt-40 md:pt-50 min-h-[80vh] md:min-h-[90vh]">
                ...
                <p className="text-gray-600 mb-6 text-sm sm:text-base">
                    We will check your payment and a notification
                    will be sent to your email address to indicate the status.
                </p>
    ...
    return (
        ...
        >
            <g clipPath="url(#clip0)">
                <path
                    d="M13.3333 10H66.6667C67.5507 10 68.3986 10.3512 69.0237 10.9763C69.6488 11.6014 70 12.4493 70 13.3333V66.6667C70 67.5507 69.6488 68.3986 69.0237 69.0237C68.3986 69.6488 67.5507 70 66.6667 70H13.3333C12.4493 70 11.6014 69.6488 10.9763 69.0237C10.3512 68.3986 10 67.5507 10 66.6667V13.3333C10 12.4493 10.3512 11.6014 10.9763 10.9763C11.6014 10.3512 12.4493 10 13.3333 10ZM16.6667 16.6667V63.3333H63.3333V16.6667H16.6667ZM36.6767 53.3333L22.5333 39.19L27.2467 34.4767L36.6767 43.9067L55.53 25.05L60.2467 29.7633L36.6767 53.3333Z"
                    fill="#31B60E"
                />
            </g>
            <defs>
